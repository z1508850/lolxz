<template>
  <div>
    <header>
      <img src="/logo.png" alt="medium-zoom" />
    </header>
    ...
    <section id="disclaimer">
      ...
      <p>本网站保留随时修改本免责声明的权利，修改后的免责声明一经发布即生效，敬请用户定期关注。</p>
      <p>感谢您的理解与合作！</p>
      <p>本网站团队</p>
      <p>日期：2024年7月29日</p>
    </section>
    ...
    <section>
      <h2>medium-zoom</h2>
      <p>![medium-zoom](/logo.png)</p>
    </section>

    <section>
      <h2>vite-plugin-markdown-preview</h2>
      <p>```vue preview<br>&lt;template&gt;<br><br>&lt;/template&gt;<br>```</p>
    </section>
  </div>
</template>
